...
# 附近查找
#   景点
# https://maps.googleapis.com/maps/api/place/nearbysearch/xml?language=zh_CN&location=31.2396889,121.4997553&radius=50000&type=TouristAttraction&keyword=attraction&key=AIzaSyAw-IJpHf6CYtb4OVgrj2MB7pmXlbSs7aY
#   购物
# https://maps.googleapis.com/maps/api/place/nearbysearch/xml?language=zh_CN&location=31.2396889,121.4997553&radius=50000&type=shoppingCenter&keyword=shopping&key=AIzaSyAw-IJpHf6CYtb4OVgrj2MB7pmXlbSs7aY
#   餐厅
# https://maps.googleapis.com/maps/api/place/nearbysearch/xml?language=zh_CN&location=31.2396889,121.4997553&radius=50000&type=restaurant&keyword=food&key=AIzaSyAw-IJpHf6CYtb4OVgrj2MB7pmXlbSs7aY
#   酒店
# https://maps.googleapis.com/maps/api/place/nearbysearch/xml?language=zh_CN&location=31.2335024,121.5057629&radius=50000&type=Hotel&keyword=hotel&key=AIzaSyAw-IJpHf6CYtb4OVgrj2MB7pmXlbSs7aY
# 下一页查找
...
# google geocoding
# https://maps.googleapis.com/maps/api/geocode/json?address=金茂大厦&key=AIzaSyAw-IJpHf6CYtb4OVgrj2MB7pmXlbSs7aY
# 知识图谱
# https://kgsearch.googleapis.com/v1/entities:search?query=taylor+swift&key=AIzaSyAw-IJpHf6CYtb4OVgrj2MB7pmXlbSs7aY&limit=1&indent=True&languages=zh_CN
...
class google_poi_spder(scrapy.Spider):
    ...
    start_urls = ['https://kgsearch.googleapis.com/v1/entities:search?query=上海影视乐园&key=AIzaSyAw-IJpHf6CYtb4OVgrj2MB7pmXlbSs7aY&limit=1&indent=True&languages=zh_CN']
    ...
    def parse(self, response):
        ...
        #             '%s&radius=50000&type=Hotel&keyword=hotel&key=AIzaSyAw-IJpHf6CYtb4OVgrj2MB7pmXlbSs7aY' % (
        #                 lat, lng)
        # print hotel_url
    ...
    def detail_parse(self, response):
        ...
        kg_search_url = 'https://kgsearch.googleapis.com/v1/entities:search?query=%s&key=AIzaSyAw-IJpHf6CYtb4OVgrj2MB7pmXlbSs7aY&limit=1&indent=True&languages=zh_CN' % name[0]
        print kg_search_url
...
if __name__ == '__main__':
    ''
    # detail_url = 'https://maps.googleapis.com/maps/api/place/details/json?placeid=ChIJM6TkgBpwsjURBfml8nNcnMM&key=AIzaSyAw-IJpHf6CYtb4OVgrj2MB7pmXlbSs7aY'
