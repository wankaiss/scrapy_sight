...
class EatTestSpider1(scrapy.Spider):
    ...
    def scenic_parse(self, response):
        ...
        """
        ctripItem = response.meta['item']
        more_scenic = response.xpath('/html/body/div[5]/div/div[2]/div[3]/div[2]/div[11]/span/a/@href').extract()
    ...
    def country_list_parse(self, response):
        ...
        """
        ctripItem = response.meta['item']
        for sel in response.xpath('/html/body/div[5]/div/div[2]/div/div[2]/div')[0:1]:  # 遍历国家里面城市列表
    ...
    def real_sight_parse(self, response):
        ...
        ctripItem = response.meta['item']
        for sel in response.xpath('/html/body/div[5]/div/div[2]/div/div[3]/div[@class="list_mod2"]')[0:1]:
    ...
    def city_parse(self, response):
        ...
        description = response.xpath('/html/body/div[4]/div/div[1]/div[4]/div[2]/div[2]/div').extract()  # description
